...
- `hermes_bot_status.py`: validates and aggregates records, detects open Hermes processes and stale writers, reads bounded session metadata for recent-session launchers, tracks notification acknowledgements, and prunes history.
